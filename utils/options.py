...
def args_parser():
    ...
    parser.add_argument('--dp_clip', type=float, default=35,  
                        help='differential privacy clip') 
    # In practice, if gradient cropping is not performed, 
    # the threshold for gradient cropping is usually set to a large constant, 
    # such as a large value (e.g., 30, 50, etc.) or to infinity.
